...
class GCNRNNTrial(NETSCAPETrial):
    ...
    def _add_specific_parser_arguments(self):
        self._argparser.add_argument("--graphs-cutoff-number", type=int, default=33,
                                     help="Number of time steps to take into consideration, used from last to first")
        self._argparser.add_argument("--gcn-dropout-rate", type=float, default=0.513333973371431,
                                     help="Dropout rate for GCN part of the network")
        self._argparser.add_argument("--lstm-dropout-rate", type=float, default=0.7376382961165022,
                                     help="Dropout rate for LSTM part of the network")
        self._argparser.add_argument("--gcn-hidden-sizes", type=str, default="[30, 30]",
